...
INDIR=/home/cosmo/stephan.rasp/2016060100/dein_ceu/
# 2. This is the output directory
OUTDIR=/home/cosmo/stephan.rasp/2016060100/deout_onlypsp/$SLURM_ARRAY_TASK_ID/
...
cat > INPUT_ORG << end_input_org
 ...
 &RUNCTL
  ...
  ydate_ini='$DATE',  nprocx = 4,  nprocy = 2,   nprocio = 0,
...
cat > INPUT_IO  << end_input_io
 ...
 &GRIBOUT
    ...
    yvarml='U         ','V         ','W         ','T         ', 'P         ',
    'RELHUM    ','TETL_TETL ','W_W       ','H2OG_H2OG ','QV        ',
    'TKE      ','QC         ','RND_BLPERT','QI        ','QS        ',
    'TTENSSTO  ','WTENSSTO ','QVTENSSTO',
    yvarzl='W         ','QC        ',
