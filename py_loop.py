...
#dates = ['2016052800', '2016052900', '2016053000', '2016053100']
typ = sys.argv[1]
#dates = [sys.argv[2]]
for date in dates:
    if typ in ['compute', 'all']:
        ...
        os.system('python compute_and_save.py --ana m --date ' + date + 
                    ' --nens 20 --tstart 3 --tend 24 --height 500 1000 1500 2000 2500 3000 3500 4000 5000 6000 7000 8000 9000 10000 &')
    if typ in ['plot', 'all']:
