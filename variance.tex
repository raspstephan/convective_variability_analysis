...
At least one plot with the characteristics of the weather situations, eg. a diprec plot. Probably in combination with all other non-var diurnal plots. 

\section{Calculation of statistics}
This section includes the details on how the statistics presented in Section ??? are computed.

\paragraph{Height level of analyses}
...
Maybe show mass flux profile and get that issue done with...
